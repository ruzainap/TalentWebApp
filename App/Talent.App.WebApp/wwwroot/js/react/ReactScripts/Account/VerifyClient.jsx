...
export default class VerifyClient extends React.Component {
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentappservicesidentity.azurewebsites.net/authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
